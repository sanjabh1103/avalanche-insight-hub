          ...
          <div className="space-y-2">
            ...
            <div className="rounded-xl border border-amber-500/20 bg-amber-500/10 p-3">
              ...
              <div className="text-[10px] text-muted-foreground">
                Colorado Rockies remains the live technical proof surface. Himalayan readiness is evidence intake and review only until local data, holdout metrics, and release-gate attestation pass.
              </div>
