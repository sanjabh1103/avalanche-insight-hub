...
const LIMITATIONS = [
  {
    ...
    detail: 'Not operational warning. System is a decision-support prototype rendering published Colorado technical artifacts.',
  },
  {
    title: 'Regional bias',
  ...
  {
    title: 'Snowpack proxy only',
    detail: 'No SNOWPACK/Crocus thermodynamic model integration. Snowpack variables are weather-derived proxies.',
  },
  {
...
const REPRO_COMMANDS = [
  { label: 'Download data', cmd: 'python -m backend.reproduction.swiss_ravafcast.cli download' },
  { label: 'Train model', cmd: 'python -m backend.reproduction.swiss_ravafcast.cli train --feature-set auto_numeric_current' },
  { label: 'Compute SHAP', cmd: 'python -m backend.reproduction.swiss_ravafcast.cli shap' },
  { label: 'Audit features', cmd: 'python -m backend.reproduction.swiss_ravafcast.cli audit-features' },
];
