        ...
        <div className="grid gap-6 p-6 md:grid-cols-[1.5fr_1fr] md:p-8">
          <div>
            ...
            <p className="mb-6 max-w-lg text-sm leading-relaxed text-muted-foreground">
              Governed ML-augmentation and comparative-validation prototype. Explore probabilistic reference outputs,
              provenance, uncertainty, and candidate-model review; the Himalayan configuration remains unvalidated.
            </p>
          ...
          <div className="flex flex-col justify-center rounded-2xl border border-border/40 bg-card/60 p-5">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-muted-foreground">Experimental reference display · not an official warning</div>
              </div>
            </div>
