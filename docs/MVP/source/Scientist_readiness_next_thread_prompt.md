...
Current deck-source note: this file is useful for workstream structure and execution discipline. It is not a proof source for current public-route functionality unless cross-checked against the May 8 proof manifest.
...
- do not use continuous-update language, authority-grade warning-service language, fully autonomous avalanche AI language, or active public MTS-LSTM language unless the artifact gate is satisfied
...
### Core docs
- `docs/MVP/source/Scientist_discussion_framework.md`
...
1. `docs/MVP/source/Scientist_claim_ledger.md`
...
2. `docs/MVP/source/Scientist_evidence_surface_ledger.md`
...
3. `docs/MVP/source/Governed_autonomy_evidence_fusion_note.md`
...
4. `docs/MVP/source/Scientist_benchmark_pack_v0.md`
...
5. `docs/MVP/source/Scientist_validation_protocol_v0.md`
...
- `docs/MVP/source/Demo_decision_brief.md`
- `docs/MVP/source/Cust_comm.md`
- `docs/MVP/source/Demo_research_appendix.md` only if you need to anchor new internal evidence references
...
- active public MTS-LSTM activation
- `authoritative SAR`
