        ...
        <Card className="border border-border/70 bg-card/60 backdrop-blur-xl">
          ...
          <CardContent className="space-y-3">
            <div className="grid grid-cols-2 gap-2 text-xs">
              ...
              <Metric label="Danger agreement" value={analytics.exact_danger_match_rate == null ? 'n/a' : `${Math.round(analytics.exact_danger_match_rate * 100)}%`} />
            ...
            <div className="rounded-lg border border-border/60 bg-black/10 p-2 text-[10px] text-muted-foreground">
              Paired comparison evidence only; not public warning authority.
            </div>
          </CardContent>
        </Card>
